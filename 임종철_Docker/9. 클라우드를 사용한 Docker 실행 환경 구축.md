...
* GCP의 [탐색 메뉴] -> > [컴퓨팅]탭 -> [Kubernetes Engine] -> [클러스터] 클릭 -> [클러스터 만들기} 클릭
...
* GCP의 [탐색 메뉴] -> > [컴퓨팅]탭 -> [Kubernetes Engine] -> [작업 부하] 클릭
...
* GCP의 [탐색 메뉴] -> > [컴퓨팅]탭 -> [Kubernetes Engine] -> [서비스 및 수신] 클릭
...
* GCP의 [탐색 메뉴] -> > [컴퓨팅]탭 -> [Kubernetes Engine] -> [클러스터] 클릭 -> 삭제하고 싶은 클러스터 선택후 [삭제] 클릭 
